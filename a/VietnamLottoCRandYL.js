...
function parseHtml(result){
   ...
   var number3b=$('.giai6').eq(1).text();
   var number4b=$('.giai6').eq(2).text();
   var number5b=$('.giai6').eq(3).text();
   var number6b=$('.giai5').eq(1).text();
   var number7b=$('.giai4').eq(1).text();
   var number8b=$('.giai4').eq(2).text();
   var number9b=$('.giai4').eq(3).text();
   var number10b=$('.giai4').eq(4).text();
   var number11b=$('.giai4').eq(5).text();
   var number12b=$('.giai4').eq(6).text();
   var number13b=$('.giai4').eq(7).text();
   var number14b=$('.giai3').eq(1).text();
