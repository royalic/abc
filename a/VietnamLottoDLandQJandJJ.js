...
function parseHtml(result){
   ...
   var number3c=a1[0]+a1[1]+a1[2]+a1[3];
   var number4c=a1[4]+a1[5]+a1[6]+a1[7];
   var number5c=a1[8]+a1[9]+a1[10]+a1[11];
   var number6c=$('.giai5').eq(1).text();
   var b1=$('.giai4').eq(1).text().split('');
   var number7c=b1[0]+b1[1]+b1[2]+b1[3]+b1[4];
   var number8c=b1[5]+b1[6]+b1[7]+b1[8]+b1[9];
   var number9c=b1[10]+b1[11]+b1[12]+b1[13]+b1[14];
   var number10c=b1[15]+b1[16]+b1[17]+b1[18]+b1[19];
   var number11c=b1[20]+b1[21]+b1[22]+b1[23]+b1[24];
   var number12c=b1[25]+b1[26]+b1[27]+b1[28]+b1[29];
   var number13c=b1[30]+b1[31]+b1[32]+b1[33]+b1[34];
   var c1=$('.giai3').eq(1).text().split('');
   var number14c=c1[0]+c1[1]+c1[2]+c1[3]+c1[4];
   var number15c=c1[5]+c1[6]+c1[7]+c1[8]+c1[9];
