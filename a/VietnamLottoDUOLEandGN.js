...
function VietnamLottoDUOLEandGN(){
...
function parseHtml(result){
   ...
   var addSql='insert ignore into VietnamLottoDUOLE(link,number1,number2,number3,number4,number5,number6,number7,number8,number9,number10,number11,number12,number13,number14,number15,number16,number17,number18) values (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)'; 
  connection.query(addSql,params,function(err,resul){
      if(err){
        console.log('[VietnamLottoDUOLE insert error]-',err.message);
      return;
      }
    console.log('[VietnamLottoDUOLE insert OK]');
});
   ...
   var addSqlb='insert ignore into VietnamLottoGN(link,number1,number2,number3,number4,number5,number6,number7,number8,number9,number10,number11,number12,number13,number14,number15,number16,number17,number18) values (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)';
  connection.query(addSqlb,paramsb,function(err,resul){
      if(err){
        console.log('[VietnamLottoGN insert error]-',err.message);
      return;
      }
    console.log('[VietnamLottoGN insert OK]');
});
connection.end(); 
};
});};
exports.VietnamLottoDUOLEandGN=VietnamLottoDUOLEandGN;
