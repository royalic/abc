...
function parseHtml(result){
   ...
   var number1b=$('.giai8').eq(3).text();
   var number2b=$('.giai7').eq(3).text();
   var number3b=$('.giai6').eq(7).text();
   var number4b=$('.giai6').eq(8).text();
   var number5b=$('.giai6').eq(9).text();
   var number6b=$('.giai5').eq(3).text();
   var number7b=$('.giai4').eq(15).text();
   var number8b=$('.giai4').eq(16).text();
   var number9b=$('.giai4').eq(17).text();
   var number10b=$('.giai4').eq(18).text();
   var number11b=$('.giai4').eq(19).text();
   var number12b=$('.giai4').eq(20).text();
   var number13b=$('.giai4').eq(21).text();
   var number14b=$('.giai3').eq(5).text();
   var number15b=$('.giai3').eq(6).text();
   var number16b=$('.giai2').eq(3).text();
   var number17b=$('.giai1').eq(3).text();
   var number18b=$('.giaidb').eq(3).text();
