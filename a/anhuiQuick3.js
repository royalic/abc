...
var connection=mysql.createConnection({
 ...
 database:'lottery'});
connection.connect();
http.get('https://kjh.55128.cn/history_ahk3.aspx', function(req, res) {
    var result = '';
...
var addSql='insert ignore into anhuiQuick3(link,firstnum,secondnum,thirdnum) values (?,?,?,?)';
