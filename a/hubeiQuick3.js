...
var connection=mysql.createConnection({
 ...
 database:'lottery'});
connection.connect();
http.get('https://kjh.55128.cn/history_hbk3.aspx', function(req, res) {
    var result = '';
...
var addSql='insert ignore into hubeiQuick3(link,firstnum,secondnum,thirdnum) values (?,?,?,?)';
