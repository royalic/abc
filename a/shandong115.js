...
function shandong115(){var connection=mysql.createConnection({
 ...
 database:'lottery'});
connection.connect();
http.get('https://kjh.55128.cn/history_sd11x5.aspx', function(req, res) {
    var result = '';
...
var addSql='insert ignore into shandong115(link,firstnum,secondnum,thirdnum,forthnum,fifthnum) values (?,?,?,?,?,?)';
