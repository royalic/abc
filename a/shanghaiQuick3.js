...
function shanghaiQuick3(){var connection=mysql.createConnection({
 host :'localhost',
 user:'root',
 password:'123456',
 port:'3306',
 database:'lottery'});
connection.connect();
http.get('https://kjh.55128.cn/history_shanghaik3.aspx', function(req, res) {
    var result = '';
...
var addSql='insert ignore into shanghaiQuick3(link,firstnum,secondnum,thirdnum) values (?,?,?,?)';
...
exports.shanghaiQuick3=shanghaiQuick3;
